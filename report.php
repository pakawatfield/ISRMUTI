...
<head>
    ...
    <link rel="stylesheet" href="test/plugin.css">
...
<body>
        ...
        <div class="container pt-10 pb-12 pt-md-14 pb-md-16 text-center">
            <div class="row">
                <div class="col-md-9 col-lg-7 col-xl-5 mx-auto">
                    <h4 class="display-1 mb-3 text-white">รายงานผลการดำเนินงาน</h4>
                </div>
            </div>
        </div>
    </section>
    ...
    $sql = "SELECT * FROM reports LIMIT $start_from, $results_per_page";
                ...
                <div class="row gx-md-8 gy-10 gy-md-13 isotope">
                    ...
                    <div class="project item col-md-6 col-xl-4 product">
                        <figure class="lift rounded mb-6">
                            <a href="image/reports/pdf/<?php echo $row['pdf_file']; ?>">
                                <img src="image/reports/<?php echo $row["cover_image"]; ?>"
                                    alt="<?php echo $row["cover_image"]; ?>" />
                            </a>
                        </figure>
                        <div class="post-header">
                            <!-- /.post-category -->
                            <h5 class="post-title h6 mt-1 mb-3">
                                <a class="link-dark" href="image/reports/pdf/<?php echo $row["pdf_file"]; ?>">
