...
<?php 
       $sql = "SELECT * FROM personal WHERE lavel_id AND personal_username = '{$_SESSION["personal_username"]}'";
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../image/teacher/<?php echo $rows["personal_img"]; ?>"
                                                target="_black">
                                                <img src="../image/teacher/<?php echo $rows["personal_img"]; ?>"
