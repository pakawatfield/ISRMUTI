...
<body>
    ...
    $sql = "SELECT * FROM academic
            WHERE academic_id = $ids"; // ใช้ LEFT JOIN เพื่อให้รวมข้อมูลจากตาราง additional_images
        ...
        <div class="container pt-10 pb-12 pt-md-14 pb-md-16 text-center">
            <div class="row">
                <div class="col-md-9 col-lg-7 col-xl-5 mx-auto">
                    ...
                    <p class="lead px-xxl-10 text-white"><?php echo $row["academic_name"]; ?></p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="blog single mt-n17">
                        <div class="card">
                            <!-- <figure class="card-img-top"><img src="image/academic/<?php echo $row["academic_img"]; ?>" alt="image/news/<?php echo $row["academic_img"]; ?>"></figure> -->
                            <div class="card-body">
                                <div class="classic-view">
                                    <article class="post">
                                        <div class="post-content mb-5">

                                            <h2 class="h1 mb-4"><?php echo $row["academic_name"]; ?></h2>
                                            <figure class="card-img-top"><img
                                                    src="image/academic/<?php echo $row["academic_img"]; ?>"
                                                    alt="image/academic/<?php echo $row["academic_img"]; ?>"></figure>
                                            <br>
                                            <p><?php echo $row["academic_detail"]; ?></p>
                                            <p>วันลงข่าว <?php echo $row["academic_date"]; ?></p>
