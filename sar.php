            ...
            <div class="container py-8 py-md-10">
                <div class="row">
                    <div class="col-lg-9 col-xl-8 col-xxl-7 mx-auto mb-8">
                        ...
                        <p class="lead fs-lg mb-10 text-center px-md-16 px-lg-21 px-xl-0">การประเมินตนเอง (SAR)
                            แสดงตามปี พ.ศ.</p>
                    </div>
                </div>
                ...
                ?>
                    <div class="col-lg-6 mb-4">
                        <figure class="lift rounded mb-6">
                            <a href="sar_curriculum.php?SARCUR_ID=<?php echo $row['SARCUR_ID']; ?>">
                                <img src="image/sar/<?=$row["SARCUR_cover_image"]; ?>"
                                    alt="<?=$row["SARCUR_name"]; ?>" />
                            </a>
                        </figure>
                        <!--/.card -->
